<template>
  <div id="login">
    <section>
      ...
      <form method="post" class="log-form"  @submit.prevent="loginUser">
        ...
        <span class="check left-align">
          ...
          <router-link
            to="/signup"
            class="loginn"
            :class="activePage == 'signup' ? 'active' : ''"
            >Sign Up</router-link
          >
        </span>
        ...
        <div class="container-log-btn">
          <router-link to="/" 
            ...
            > <button type="submit" name="btn_submit" class="log-form-btn" ><span>Log In</span>
          </button></router-link>
        </div>
      </form>
    </section>
